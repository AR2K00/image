...
def applyfilter(filename, preset):
    inputfile = 'C:/Users/aksha/Documents/School/Spring 2021/Cloud Computing/imagepro/media/' + filename

    f = filename.split('.')
    outputfilename = f[0] + '-out.jpg'

    outputfile = 'C:/Users/aksha/Documents/School/Spring 2021/Cloud Computing/imagepro/myapp/templates/static/output/' + outputfilename
